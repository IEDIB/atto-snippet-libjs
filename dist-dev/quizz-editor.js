...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_editor_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59);
...
/* harmony import */ var _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60);
/* harmony import */ var _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__);
// Imports



var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(61), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(62), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(63), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(64), __webpack_require__.b);
...
/* harmony import */ var _widgetElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(66);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
/* harmony import */ var _bs_dialog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(67);
...
var MAX_ELEMS = 6;
var panel = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.createElement)('div', {
...
var quizzNumeditHint = panel.querySelector("#quizz-numedit-hint");
...
var IBQuizzDropdown = (_dec = (0,_decorators__WEBPACK_IMPORTED_MODULE_0__.ComponentHTML)({
  ...
  _createClass(IBQuizzDropdown, [{
    ...
    value: function successCb() {
      ...
      var output = btoa(JSON.stringify(updated));
    ...
    value: function edit() {
      ...
      var dialog = (0,_bs_dialog__WEBPACK_IMPORTED_MODULE_3__.getDialog)('ib-quizz-editor-dlg', 'Editar "Opció simple"');
      dialog.setBody(panel);
      dialog.show(this.successCb.bind(this));
    }
  }]);
  return IBQuizzDropdown;
}(_widgetElement__WEBPACK_IMPORTED_MODULE_1__.WidgetElement)) || _class);
...
var BSDialog = /*#__PURE__*/function () {
  ...
  _createClass(BSDialog, [{
    ...
    value: function show(cb) {
      ...
      this.primaryBtn.off();
      this.primaryBtn.on('click', function () {
        cb();
        //@ts-ignore
...
var dialogCache = {};
function getDialog(id, title) {
  var dlg = dialogCache[id];
  if (!dlg) {
...
/* harmony import */ var _bs_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
/* harmony import */ var _widgetElement__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(66);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
var _dec, _class;
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var quizzNumEditIni = panel.querySelector("#quizz-numedit-ini");
...
function getValues() {
  var updated = {
    ...
    ini: (quizzNumEditIni === null || quizzNumEditIni === void 0 ? void 0 : quizzNumEditIni.value) || "",
    hint: quizzNumeditHint.value || "",
    fbk: quizzNumeditFeedback.value || "",
    pre: quizzNumeditPre.value || "",
    opts: {
...
var IBQuizzNumeric = (_dec = (0,_decorators__WEBPACK_IMPORTED_MODULE_0__.ComponentHTML)({
  ...
  _createClass(IBQuizzNumeric, [{
    ...
    value: function edit() {
      ...
      // Update controls with values from config
      setValues(this.config);
      var dialog = (0,_bs_dialog__WEBPACK_IMPORTED_MODULE_2__.getDialog)('ib-quizz-editor-dlg', 'Editar "Numèric""');
      dialog.setBody(panel);
      dialog.show(this.successCb.bind(this));
    }
  }]);
...
var quizzDDshuffle = panel.querySelector("#quizzDDshuffle");
var mchoiceEditPre = panel.querySelector("#quizz-mchoiceedit-pre");
var mchoiceEditFeedback = panel.querySelector("#quizz-mchoiceedit-feedback");
var mchoiceEditHint = panel.querySelector("#quizz-mchoiceedit-hint");
function setValues(w) {
  var _w$opts;
  // Opcions correctes són
  var allRight = w.ans.split(",").map(function (e) {
...
var IBQuizzMchoice = (_dec = (0,_decorators__WEBPACK_IMPORTED_MODULE_0__.ComponentHTML)({
  ...
  _createClass(IBQuizzMchoice, [{
    ...
    value: function edit() {
      ...
      // Update controls with values from config
      setValues(this.config);
      var dialog = (0,_bs_dialog__WEBPACK_IMPORTED_MODULE_2__.getDialog)('ib-quizz-editor-dlg', 'Editar "Opció múltiple"');
      dialog.setBody(panel);
      dialog.show(this.successCb.bind(this));
    }
  }]);
...
function getValues() {
  var updated = {
    ini: (quizzNumEditIni === null || quizzNumEditIni === void 0 ? void 0 : quizzNumEditIni.value) || "?",
    cfn: (quizzNumEditCfn === null || quizzNumEditCfn === void 0 ? void 0 : quizzNumEditCfn.value) || "",
    ans: (quizzNumEditAns === null || quizzNumEditAns === void 0 ? void 0 : quizzNumEditAns.value) || "[0]",
    hint: quizzNumeditHint.value || "",
    fbk: quizzNumeditFeedback.value || "",
    pre: quizzNumeditPre.value || "",
...
var IBQuizzCloze = (_dec = (0,_decorators__WEBPACK_IMPORTED_MODULE_0__.ComponentHTML)({
  ...
  _createClass(IBQuizzCloze, [{
    ...
    value: function edit() {
      ...
      // Update controls with values from config
      setValues(this.config);
      var dialog = (0,_bs_dialog__WEBPACK_IMPORTED_MODULE_2__.getDialog)('ib-quizz-editor-dlg', 'Editar "Cloze fórmula"');
      dialog.setBody(panel);
      dialog.show(this.successCb.bind(this));
    }
  }]);
...
!function() {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _editor_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58);
/* harmony import */ var _dropdownWidget__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65);
/* harmony import */ var _numericWidget__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68);
/* harmony import */ var _mchoiceWidget__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(69);
/* harmony import */ var _clozeWidget__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(70);

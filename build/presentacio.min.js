window.IB = window.IB || {}; window.IB.sd = window.IB.sd || {};  
         !function(){if(document.getElementById("sd_css_presentacio.js")){return;}; var l = 'div[role="presentacio"] {   margin: auto;   border-radius: 5px;   border: 1px solid gray;   width: 600px;  }    .container {        margin: 20px 400px;        height: 300px;       width: 50%;       background-color: powderblue;      }        .box_continguts {        padding-top: 20px;        padding-left: 20px;        padding-right: 20px;        font-size: 20px;        height: 250px;         background-color: powderblue;      }        .box_botons {        padding-left: 20px;        padding-top: 10px;        font-size: 20px;        height: 50px;         background-color: powderblue;      } '; var s = document.createElement('style'); s.type = 'text/css'; s.innerHTML = l; s.id="sd_css_presentacio.js"; document.getElementsByTagName('head')[0].appendChild(s);}();

...
!function(){"use strict";var t="<span>&#10094;</span>",e="<span>&#10095;</span>",a="snptModal_lightbox",r="lightbox";if(window.IB.sd[r])return void console.error("Warning: "+r+" loaded twice.");var n=function(){for(var t=0,e=[],i=document.querySelectorAll("[data-galery]"),a=0,r=i.length;r>a;a++){var n=i[a],o=(n.tagName||"").toUpperCase();if("DIV"==o||"TABLE"==o){if("lightbox"!=n.dataset.snptd&&"snptd_lightbox"!=n.getAttribute("role"))continue;for(var s=n.querySelectorAll("img"),l=0,d=s.length;d>l;l++){var c=s[l];c.dataset.lbpos=t,t++,e.push(c)}}else if("IMG"==o){if("lightbox"!=n.dataset.snptd&&"snptd_lightbox"!=n.getAttribute("role"))continue;n.dataset.lbpos=t,t++,e.push(n)}}return e},o=function(){this.$gallery=n(),this._createModal(),this.currentIndex=0;for(var t=0;t<this.$gallery.length;t++)this._setupImage(this.$gallery[t])};o.prototype._setupImage=function(t){var e=this,i=$(t);"1"!=i.attr("data-active")&&(i.css("cursor","pointer"),i.attr("data-toggle","modal"),i.attr("data-target","#"+a),i.attr("data-active","1"),i.off(),i.on("click",function(t){e.currentIndex=parseInt(this.dataset.lbpos),e._loadImageDynamically()}))},o.prototype._loadImageDynamically=function(){var t=this;if(!this.$gallery[this.currentIndex])return void console.error("Nothing at currentIndex",this.currentIndex);var e=$(this.$gallery[this.currentIndex]);if(t.$img.length){var i=new Image,a=e.attr("data-src")||e.attr("src");i.onload=function(){t._resize(i.width,i.height),t.$img.attr("src",a)},i.onerror=function(e){console.error("Cannot load image ",e),t.$img.attr("src","")},i.src=a}},o.prototype._createModal=function(){var i=this,r=this.$gallery.length>1,n='<a class="navigate-left-arrow" href="javascript:void(0);">'+t+"</a>",o='<a class="navigate-right-arrow" href="javascript:void(0);">'+e+"</a>",s=$('<div class="modal fade modal-fullscreen-xl" id="'+a+'" tabindex="-1" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close text-white" data-dismiss="modal">&times;</button></div><div class="modal-body p-0" style="text-align:center;">'+(r?n:"")+'<img src="">'+(r?o:"")+"</div></div></div></div>");this.$modal=$(s),this.$img=this.$modal.find("img"),this.$close=this.$modal.find("button"),$("body").append(this.$modal),this.$modal.on("hide.bs.modal",function(){i.$img.attr("src","")}),$("#modalCloseBtn").on("click",function(){i.$img.attr("src","")}),r&&(this.$modal.find(".navigate-left-arrow").on("click",function(t){t.preventDefault(),i._navigateLeft()}),this.$modal.find(".navigate-right-arrow").on("click",function(t){t.preventDefault(),i._navigateRight()}))},o.prototype._resize=function(t,e){var i=1;e>0&&(i=t/e);var a=$(window).height(),r=$(window).width(),n=1;r>0&&(n=a/r),i>n?(this.$img.css("width","initial"),this.$img.css("height","100%")):(this.$img.css("height","initial"),this.$img.css("width","100%"))},o.prototype._loadImageDynamically=function(){var t=this;if(!this.$gallery[this.currentIndex])return void console.error("Nothing at currentIndex",this.currentIndex);var e=$(this.$gallery[this.currentIndex]);if(t.$img.length){var i=new Image,a=e.attr("data-src")||e.attr("src");i.onload=function(){t._resize(i.width,i.height),t.$img.attr("src",a)},i.onerror=function(e){console.error("Cannot load image ",e),t.$img.attr("src","")},i.src=a}},o.prototype._navigateLeft=function(){0==this.currentIndex?this.currentIndex=this.$gallery.length-1:this.currentIndex=this.currentIndex-1,this._loadImageDynamically()},o.prototype._navigateRight=function(){this.currentIndex==this.$gallery.length-1?this.currentIndex=0:this.currentIndex=this.currentIndex+1,this._loadImageDynamically()},o.prototype.dispose=function(){for(var t=0;t<this.$gallery.length;t++){var e=$(this.$gallery[t]);e.removeAttr("data-active"),e.removeAttr("data-toggle"),e.removeAttr("data-target"),e.css("cursor","initial"),e.off()}var i=$("#"+a);i.off(),i.remove()};var s={author:"Josep Mulet",version:"2.1"};window.IB.sd[r]=s;var l=function(){var t=new o;window.IB.sd[r].inst=t};s.bind=l,s.unbind=function(){var t=Object.values(s.inst);t[i].dispose(),s.inst=null},l()}();
...
!function(){var t="presentacio";if(window.IB.sd[t])return console.error("Warning: "+t+" loaded twice."),void(window.IB.sd[t].bind&&window.IB.sd[t].bind());var i=5,n=function(t){var n=this,e=t.dataset;this.loop="1"==e.loop||"true"==e.loop;for(var s=t.querySelectorAll("ul.nav.nav-tabs > li > a"),a=0,o=s.length;o>a;a++)s[a].innerHTML="&nbsp; "+(a+1)+"/"+o;if(this.container=t,this.container.style.overflow="hidden",this.button_container=document.createElement("div"),this.button_container.className="box_botons",t.append(this.button_container),this.diapositives=t.querySelectorAll("div.tab-content > div.tab-pane"),this.num=this.diapositives.length,this.n=0,e.start)try{this.n=(parseInt(e.start)-1)%this.num}catch(r){console.error(r)}for(var u="fade"==e.transition,a=0;a<this.num;a++)this.diapositives[a].dataset.label=a+1+"/"+this.num,this.diapositives[a].classList.remove("iedib-tabpane"),u&&this.diapositives[a].classList.add("fade"),a==this.n?this.diapositives[a].classList.add("active"):this.diapositives[a].classList.remove("active");var h=(e.durades||"0").trim();this.continuarAutomatic="0"!=h;var c=h.split(",");if(1==c.length)try{i=parseInt(c[0])}catch(r){console.error(r)}this.durada=[];for(var l=c.length,d=0;d<this.num;d++){var p=i;if(d>=l)this.durada.push(p);else try{p=parseInt(c[d]),null!=p&&this.durada.push(p)}catch(r){console.error(r)}}this._crearBotons(),this._carregaListeners();var v=e.autostart;"1"!=e.loop&&"true"!=e.loop&&(v="0"),"1"==v||"true"==v?this.continuarAutomatic&&this.n<this.num&&(this._updateCounter(),this.currentTimeout=setTimeout(function(){n.seguent()},1e3*this.durada[this.n])):this.continuarAutomatic?(this.continuarAutomatic=!1,this.buttonPlay&&(this.buttonPlay.innerHTML='<i class="fas fa-play"></i>'),this._updateCounter()):this._updateCounter()};n.prototype._eliminarActive=function(){for(var t=0;t<this.num;t++)this.diapositives[t].classList.remove("active")},n.prototype._updateCounter=function(){if(this.boxComptador.innerHTML="&nbsp;&nbsp;&nbsp;&nbsp; "+(this.n+1)+" / "+this.num,this.currentTimeout&&(clearInterval(this.currentTimeout),this.currentTimeout=null),this.continuarAutomatic){if(!this.loop&&this.n==this.num-1)return this.continuarAutomatic=!1,void(this.buttonPlay&&(this.buttonPlay.innerHTML='<i class="fas fa-play"></i>'));var t=this;this.currentTimeout=setTimeout(function(){t.seguent()},1e3*this.durada[this.n]),this.buttonPlay&&(this.buttonPlay.innerHTML='<i class="fas fa-pause"></i>')}else this.buttonPlay&&(this.buttonPlay.innerHTML='<i class="fas fa-play"></i>')},n.prototype.seguent=function(){if(this.n>=this.num-1){if(!this.loop)return;this.n=-1}this._eliminarActive(),this.n+=1,this.diapositives[this.n].classList.add("active"),this._updateCounter()},n.prototype.anterior=function(){if(0==this.n){if(!this.loop)return;this.n=this.num}this._eliminarActive(),this.n-=1,this.diapositives[this.n].classList.add("active"),this._updateCounter()},n.prototype.primer=function(){this._eliminarActive(),this.n=0,this.diapositives[this.n].classList.add("active"),this.continuarAutomatic=!1,this._updateCounter()},n.prototype.darrer=function(){this._eliminarActive(),this.n=this.num-1,this.diapositives[this.n].classList.add("active"),this.continuarAutomatic=!1,this._updateCounter()},n.prototype.pausa=function(){this.continuarAutomatic=!1,null!=this.currentTimeout&&(clearTimeout(this.currentTimeout),this.currentTimeout=null),this.buttonPlay.innerHTML='<i class="fas fa-play"></i>'},n.prototype.play=function(){var t=this;this.continuarAutomatic=!0,this.currentTimeout=setTimeout(function(){t.seguent()},1e3*this.durada[this.n]),this.buttonPlay.innerHTML='<i class="fas fa-pause"></i>'},n.prototype._carregaListeners=function(){var t=this;this.evListener1=this.buttonFirst.addEventListener("click",function(i){t.primer()}),this.evListener2=this.buttonLast.addEventListener("click",function(i){t.darrer()}),this.evListener3=this.buttonNext.addEventListener("click",function(i){t.seguent()}),this.evListener4=this.buttonBack.addEventListener("click",function(i){t.anterior()}),t.continuarAutomatic&&(this.evListener5=this.buttonPlay.addEventListener("click",function(i){t.continuarAutomatic?t.pausa():t.play()}))},n.prototype.dispose=function(){this.currentTimeout&&window.clearTimeout(this.currentTimeout),this.evListener1&&window.removeEventListener("click",this.evListener1),this.evListener2&&window.removeEventListener("click",this.evListener2),this.evListener3&&window.removeEventListener("click",this.evListener3),this.evListener4&&window.removeEventListener("click",this.evListener4),this.evListener5&&window.removeEventListener("click",this.evListener5),this.container.dataset.active="0",this.container.remove(this.button_container)};var e=function(t,i){var n=document.createElement("button");n.className=t;var e=document.createElement("i");return e.className=i,n.appendChild(e),n};n.prototype._crearBotons=function(){this.buttonFirst=e("btn btn-sm btn-outline-primary btn-first","fas fa-fast-backward"),this.button_container.appendChild(this.buttonFirst),this.buttonFirst.title="First",this.buttonBack=e("btn btn-sm btn-outline-primary btn-step-backward","fas fa-chevron-left"),this.button_container.appendChild(this.buttonBack),this.buttonBack.title="Previous",this.buttonNext=e("btn btn-sm btn-outline-primary btn-step-forward","fas fa-chevron-right"),this.button_container.appendChild(this.buttonNext),this.buttonNext.title="Next",this.buttonLast=e("btn btn-sm btn-outline-primary btn-last","fas fa-fast-forward"),this.buttonLast.title="Last",this.button_container.appendChild(this.buttonLast),this.continuarAutomatic&&(this.buttonPlay=e("btn btn-sm btn-primary btn-step-play","fas fa-pause"),this.buttonPlay.style["margin-left"]="15px",this.buttonPlay.title="Play/Pause",this.button_container.appendChild(this.buttonPlay)),this.boxComptador=document.createElement("div"),this.boxComptador.className="box_comptador",this.button_container.appendChild(this.boxComptador)};var s={author:"Tomeu Fiol, Josep Mulet",version:"1.6",inst:{}};window.IB.sd[t]=s;var a=function(){for(var i=document.querySelectorAll('div[role="snptd_presentacio"]'),e=0,s=i.length;s>e;e++){var a=i[e];if(!a.dataset.active){a.dataset.active="1";var o=new n(a),r=a.getAttribute("id");r||(r="dynamic_"+Math.random().toString(32).substring(2),a.id=r),window.IB.sd[t].inst[r]=o}}};s.bind=a,s.unbind=function(){for(var t=Object.values(s.inst),i=0,n=t.length;n>i;i++)t[i].dispose();s.inst={}},a()}();

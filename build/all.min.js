    ...
    !function(){if(document.getElementById("sd_css_all")){return;}; var l = '  .iedib-rwrap {   text-align: right;   font-size: 0; } .iedib-ctx {   display: inline-block;   border-top-left-radius: 50%;   border-bottom-left-radius: 50%;   background: rgb(31, 106, 219);   color: rgb(241, 245, 254);   margin: 0;   padding: 4px;   font-size: 11px; } .iedib-time {   display: inline-block;   margin: 0px;   padding: 5px;   border-bottom-right-radius: 5px;   border-top-right-radius: 5px;   background: rgb(241, 245, 254);   color: rgb(31, 106, 219);   font-size: 12px; } .iedib-time>span {   font-weight: bold; } div[role="presentacio"] {  margin: auto;  border-radius: 5px;  border: 1px solid gray;  width: 600px; }  .box_continguts {  padding-top: 20px;  padding-left: 20px;  padding-right: 20px;  font-size: 20px;  height: 250px;  background-color: powderblue; } .box_botons {  padding-left: 20px;  padding-top: 10px;  font-size: 20px;  height: 50px;  background-color: powderblue; } .sd-speak-enabled {   position: relative;   background: whitesmoke;   text-decoration: none;   }  @keyframes speakicon_anim {   0% {    opacity: 0;    left: -10px;   }   100% {    opacity: 1;    left: -5px;   }  }  .sd-speak-enabled:hover:after {   content: "\\f0a1";   position: absolute;   left: -5px;   top: -16px;   background: white;   z-index:1000;   font-family: "Font Awesome\\ 5 Pro";   font-size: 70%;   margin: 0px 5px;   font-weight: 700;   vertical-align:top;   animation: speakicon_anim 1s ease;  }'; var s = document.createElement('style'); s.type = 'text/css'; s.innerHTML = l; s.id="sd_css_all"; document.getElementsByTagName('head')[0].appendChild(s);}();
    !function(){var e=110,t=2,n=5,i=10,r=5,a="dedicacio";if(window.IB.sd[a])return console.error("Warning: "+a+" loaded twice."),void(window.IB.sd[a].bind&&window.IB.sd[a].bind());var o=function(e){var t=e.querySelector("span");if(t){var n=t.innerText.trim();this.container=e,this.aSpan=t,n||this.estimate()}};o.prototype={estimate:function(){if(this.aSpan){var a=document.querySelector("div.no-overflow"),o=a.innerText.replace(/\s+/g," ").split(" "),s=o.length,d=0;s>0&&(d=s/e);var l=a.querySelectorAll("img").length;d+=l*t;var c=a.querySelectorAll("table").length;d+=c*n;var v=a.querySelectorAll(".iedib-video-container").length;d+=v*i;var u=a.querySelector(".iedib-proposat");if(u){var h=3;d+=h*r}var f="";if(d>60){var p=Math.floor(d/60),w=d-60*p;w=10*Math.floor(w/10),w>0&&(f+=p+" h "+w+" min")}else d=5*Math.round(d/5),f=d+" min";5>d?this.container.parentElement.style.display="none":this.aSpan.innerText=f}},dispose:function(){this.container.dataset.active="",this.aSpan&&(this.aSpan.innerHTML="")}};var s={author:"Josep Mulet",version:"1.0",inst:{}};window.IB.sd[a]=s;var d=function(){for(var e=document.querySelectorAll('[role="'+a+'"]'),t=0,n=e.length;n>t;t++){var i=e[t];if(!i.dataset.active){i.dataset.active="1";var r=new o(i),s=i.getAttribute("id");s||(s="dynamic_"+Math.random().toString(32).substring(2),i.id=s),window.IB.sd[a].inst[s]=r}}};s.bind=d,s.unbind=function(){for(var e=Object.values(s.inst),t=0,n=e.length;n>t;t++)e[t].dispose();s.inst={}},d()}();

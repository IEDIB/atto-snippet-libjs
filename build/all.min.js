...
!function(){var t="presentacio";if(window.IB.sd[t])return console.error("Warning: "+t+" loaded twice."),void(window.IB.sd[t].bind&&window.IB.sd[t].bind());var i=4,n=function(t){var n=this,s=t.querySelector("ul.nav.nav-tabs");s.style.display="none",this.container=t,this.button_container=document.createElement("div"),this.button_container.className="box_botons",t.append(this.button_container),this.diapositives=t.querySelectorAll("div.tab-content > div.tab-pane"),this.num=this.diapositives.length;for(var a=0,e=0;e<this.num;e++){var o=this.diapositives[e].offsetHeight;o>a&&(a=o)}this.n=0;for(var e=0;e<this.num;e++)this.diapositives[e].style.height=a+"px",this.diapositives[e].classList.contains("active")&&(this.n=e);var r=t.dataset,u=(r.durations||"0").trim();this.continuarAutomatic="0"!=u;var h=u.split(",");this.durada=[];for(var c=h.length,d=0;d<this.num;d++){var l=i;if(d>=c)this.durada.push(l);else try{l=parseInt(h[d]),null!=l&&this.durada.push(l)}catch(p){}}this._crearBotons(),this._carregaListeners(),null==r.autostart||"false"!=r.autostart?this.continuarAutomatic&&this.n<this.num&&(this.currentTimeout=setTimeout(function(){n.seguent()},1e3*this.durada[this.n])):this.continuarAutomatic&&(this.continuarAutomatic=!1,this.buttonPlay&&(this.buttonPlay.innerHTML='<i class="fas fa-play"></i>'),this._updateCounter())};n.prototype._eliminarActive=function(){for(var t=0;t<this.num;t++)this.diapositives[t].classList.remove("active")},n.prototype._updateCounter=function(){if(this.boxComptador.innerHTML="&nbsp;&nbsp;&nbsp;&nbsp; "+(this.n+1)+" / "+this.num,this.currentTimeout&&(clearInterval(this.currentTimeout),this.currentTimeout=null),this.continuarAutomatic){if("false"==this.container.dataset.loop&&this.n==this.num-1)return this.continuarAutomatic=!1,void(this.buttonPlay.innerHTML='<i class="fas fa-play"></i>');var t=this;this.currentTimeout=setTimeout(function(){t.seguent()},1e3*this.durada[this.n]),this.buttonPlay.innerHTML='<i class="fas fa-pause"></i>'}else this.buttonPlay.innerHTML='<i class="fas fa-play"></i>'},n.prototype.seguent=function(){this._eliminarActive(),this.n+=1,this.n==this.num&&(this.n=0),this.diapositives[this.n].classList.add("active"),this._updateCounter()},n.prototype.anterior=function(){this._eliminarActive(),this.n-=1,this.n<0&&(this.n=this.num-1),this.diapositives[this.n].classList.add("active"),this._updateCounter()},n.prototype.primer=function(){this._eliminarActive(),this.n=0,this.diapositives[this.n].classList.add("active"),this.continuarAutomatic=!1,this._updateCounter()},n.prototype.darrer=function(){this._eliminarActive(),this.n=this.num-1,this.diapositives[this.n].classList.add("active"),this.continuarAutomatic=!1,this._updateCounter()},n.prototype.pausa=function(){this.continuarAutomatic=!1,null!=this.currentTimeout&&(clearTimeout(this.currentTimeout),this.currentTimeout=null),this.buttonPlay.innerHTML='<i class="fas fa-play"></i>'},n.prototype.play=function(){var t=this;this.continuarAutomatic=!0,this.currentTimeout=setTimeout(function(){t.seguent()},1e3*this.durada[this.n]),this.buttonPlay.innerHTML='<i class="fas fa-pause"></i>'},n.prototype._carregaListeners=function(){var t=this;this.buttonFirst.addEventListener("click",function(i){t.primer()}),this.buttonLast.addEventListener("click",function(i){t.darrer()}),this.buttonNext.addEventListener("click",function(i){t.seguent()}),this.buttonBack.addEventListener("click",function(i){t.anterior()}),t.continuarAutomatic&&this.buttonPlay.addEventListener("click",function(i){t.continuarAutomatic?t.pausa():t.play()})};var s=function(t,i){var n=document.createElement("button");n.className=t;var s=document.createElement("i");return s.className=i,n.appendChild(s),n};n.prototype._crearBotons=function(){this.buttonFirst=s("btn btn-outline-primary btn-first","fas fa-fast-backward"),this.button_container.appendChild(this.buttonFirst),this.buttonFirst.title="First",this.buttonBack=s("btn btn-outline-primary btn-step-backward","fas fa-chevron-left"),this.button_container.appendChild(this.buttonBack),this.buttonBack.title="Previous",this.buttonNext=s("btn btn-outline-primary btn-step-forward","fas fa-chevron-right"),this.button_container.appendChild(this.buttonNext),this.buttonNext.title="Next",this.buttonLast=s("btn btn-outline-primary btn-last","fas fa-fast-forward"),this.buttonLast.title="Last",this.button_container.appendChild(this.buttonLast),this.continuarAutomatic&&(this.buttonPlay=s("btn btn-primary btn-step-play","fas fa-pause"),this.buttonPlay.style["margin-left"]="15px",this.buttonPlay.title="Play/Pause",this.button_container.appendChild(this.buttonPlay)),this.boxComptador=document.createElement("div"),this.boxComptador.className="box_comptador",this.button_container.appendChild(this.boxComptador)};var a={author:"Josep Mulet",version:"1.0",inst:{}};window.IB.sd[t]=a;var e=function(){for(var i=document.querySelectorAll('div[role="snptd_presentacio"]'),s=0,a=i.length;a>s;s++){var e=i[s];if(!e.dataset.active){e.dataset.active="1";var o=new n(e),r=e.getAttribute("id");r||(r="dynamic_"+Math.random().toString(32).substring(2),e.id=r),window.IB.sd[t].inst[r]=o}}};a.bind=e,a.unbind=function(){for(var t=Object.values(a.inst),i=0,n=t.length;n>i;i++)t[i].dispose();a.inst={}},e()}();
!function(){var e="xcode",n="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.3.1/styles/"+e+".min.css",i="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.3.1/highlight.min.js",l="https://cdnjs.cloudflare.com/ajax/libs/highlightjs-line-numbers.js/2.8.0/highlightjs-line-numbers.min.js",t=function(e,n){var i=document.createElement("link");i.rel="stylesheet",i.type="text/css",i.href=e,n&&(i.id=n),document.getElementsByTagName("head")[0].appendChild(i)},s=function(e,n,i){var l=document.createElement("script");l.src=e,l.async=!1,n&&(l.id=n),i&&(l.onload=function(){i()}),document.getElementsByTagName("head")[0].appendChild(l)},h=function(){var e=function(){a()},n=function(){s(l,"highlight-numbering.min",e)};s(i,"highlight.min",n)},a=function(){if(window.hljs&&!hljs.highlightElement)return void console.error("ERROR> S'ha detectat una versió antiga de hljs a la pàgina que impedeix que es carregui la nova. Eliminau l'script manualment.");for(var e=document.querySelectorAll("pre code"),n=0,i=e.length;i>n;n++){var l=e[n];hljs&&!l.classList.contains("nohighlight")&&(hljs.highlightElement(l),hljs.lineNumbersBlock&&!l.classList.contains("nohljsln")&&hljs.lineNumbersBlock(l,{singleLine:!0}))}};document.querySelector("#hljs_styles")||t(n,"hljs_styles"),window.hljs?a():h()}();
